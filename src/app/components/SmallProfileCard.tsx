...
//     return (
//         <div>
//             <div className='md:ms-0 ms-5 md:mt-0 text-sm md:me-0 me-5'>
//                 <div className="mt-3 md:h-[calc(75vh-20px)] h-[calc(80vh-50vh)] md:overflow-y-scroll">
//                     {items.map((item) => (
//                         <div key={item.id} className="block max-w-2xl p-2 mt-3 bg-white border border-blue-200 rounded-lg shadow">
