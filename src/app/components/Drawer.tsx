...
//         <>
//             <div className='me-8'>
//                 <button onClick={() => setOpen(true)} className='md:hidden block bottom-5 right-2 h-8 w-20 rounded-lg px-2 py-1 font-bold bg-[#5932EA] text-center text-white fixed'>Job List</button>
//             </div>
...
//                             <div className='flex w-screen justify-center items-center md:hidden block'>
//                                 <div className='md:ms-0  md:mt-0 text-sm'>
//                                     <div className="mt-0 mg:w-[72vh] ms:w-[63vh] w-[53vh] md:h-[calc(75vh-20px)] h-[calc(177vh-90vh)] md:overflow-y-scroll overflow-scroll md:hidden block ">
//                                         {items.map((item) => (
//                                             <div key={item.id} onClick={() => setSelectedItemcard(item.id)} className="block p-2 mt-3 overflow-scroll bg-white border border-blue-200 rounded-lg shadow">
...
//             togglePopup(id);
//         }, 1000); // Adjust the long-press duration as needed (1000ms = 1 second)
...
//                                                 className="block p-2 mt-3 overflow-scroll bg-white border border-blue-200 rounded-lg shadow"
//                                             >
//                                                 <div className="flex md:flex-row flex-col">
//                                                     <div className="md:w-1/2">
//                                                         <p className="font-bold md:text-md text-md ">{item.title}</p>
...
//                                                     </div>
//                                                     {activePopupId === item.id && (
//                                                         <div className="absolute md:right-[57%] right-[10%] mt-2 w-58 py-2 bg-white border border-gray-200 rounded-lg shadow-xl z-10 text-sm">
//                                                             <a href="#" className="flex px-4 py-2 text-gray-800 hover:bg-gray-100 "><CiShare2 className='mt-1' /><span className='ms-2'>Share This Job</span></a>
//                                                             <a href="#" className="flex px-4 py-2 text-gray-800 hover:bg-gray-100"><ImNewTab className='mt-1' /><span className='ms-2'>Open In New Tab</span></a>
//                                                             <a href="#" className="flex px-4 py-2 text-gray-800 hover:bg-gray-100"><MdBlockFlipped className='mt-1' /><span className='ms-2'>Not Interested</span></a>
//                                                             <a href="#" className="flex px-4 py-2 text-gray-800 hover:bg-gray-100"><CiFlag1 className='mt-1' /><span className='ms-2'>Problem With This Job?</span></a>
...
//                                     <div className="mt-0 mg:w-[72vh] ms:w-[63vh] w-[53vh] md:h-[calc(75vh-20px)] h-[calc(177vh-90vh)] md:overflow-y-scroll overflow-scroll md:hidden block ">
//                                         {items.map((item) => (
//                                             <div key={item.id} onClick={() => { setSelectedItemcard(item.id); setOpen(false); }} className="block p-2 mt-3 overflow-scroll bg-white border border-blue-200 rounded-lg shadow">
//                                                 <div className="flex md:flex-row flex-col ">
//                                                     <div className="md:w-1/2">
//                                                         <p className="font-bold md:text-md text-md ">{item.title}</p>
//                                                     </div>
...
const Drawercard: React.FC = () => {
    ...
    return (
        <>
            <div className='me-8'>
                <button onClick={handleOpenPopup} className='md:hidden block bottom-5 right-2 h-8 w-20 rounded-lg px-2 py-1 font-bold bg-[#5932EA] text-center text-white fixed'>Job List</button>
            </div>
            <Sheet isOpen={isOpen} onClose={() => setOpen(false)}
                snapPoints={[600, 400, 200, 0]}
                initialSnap={1}
