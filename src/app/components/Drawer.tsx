...
//                                     <div className="h-[calc(185dvh-95dvh)] md:overflow-y-scroll overflow-scroll md:hidden block " onScroll={()=> setActivePopupId(null)}>
//                                         {items.map((item) => (
//                                             <>
...
// //         setSelectedItemcard(id);
// //         setOpen(false);
// //         setScrollPosition(cardRefs.current[id]?.offsetTop || 0);
// //     };
...
// //                                                     className="block flex p-2 w-screen mt-3 overflow-scroll bg-white border border-blue-200 rounded-lg shadow"
// //                                                 >
// //                                                     <div className="flex w-3/2 ">
// //                                                         <div className="" onClick={() => handleItemClick(item.id)}>
// //                                                             <div className="flex md:flex-row flex-col">
