...
const Drawercard: React.FC<ShareButtonProps> = ({ setOpen, setSelectedItemcard, isOpen, selectedItemcard, onClick, onBackClick, onBackDrawerClick, onOpenDrawer, title, text, url }) => {
    ...
    //     return <CustomCard onBackClick={() => setSelectedItemcard(null)} onClick={() => setOpen(false)} onBackDrawerClick={() => setOpen(true)} />
    // }
                ...
                <Sheet.Container>
                    ...
                    <Sheet.Content>
                        <div className='md:hidden block'>
                            <div className='flex w-screen p-1 justify-center items-center' onClick={handleClosePopup}>
                                <div className='text-sm  md:hidden block'>
                                    <div ref={scrollContainerRef} className="h-[calc(185dvh-95dvh)] md:overflow-y-scroll overflow-scroll md:hidden block" onScroll={() => setActivePopupId(null)}>
                                        {items.map((item) => (
                                            <div key={item.id} onContextMenu={(e) => handleContextMenu(e, item.id)} className=" flex p-2 w-screen mt-3 overflow-scroll bg-white border border-blue-200 rounded-lg shadow">
