...
const TurnTo: React.FC<ShareButtonProps> = ({ title, text, url }) => {
    ...
    return (
        <>
            <div className="flex flex-col scrollhide">
                <div className="md:flex md:flex-row flex-col md:w-full md:-mt-1 mt-1 w-screen">
                    <div className="flex mt-2 md:max-w-lg md:ms-0 ms-2 md:me-0 me-3">
                    ...
                    <form className="max-w-2xl mx-auto md:max-w-xl flex md:mt-0 mt-1 md:ms-0 ms-2 md:me-0 me-3">
                        <div className="flex md:w-64 w-full">
                            <div className="relative w-full md:mt-2">
                                ...
                                <input type="search" id="default-search" className="block w-full md:p-2 p-0.5 md:ps-8 ps-10 text-sm text-gray-900 border md:rounded-none md:w-[85%] rounded-md bg-gray-200" placeholder="360001, Rajkot, Gujarat" required />
                                <button type="submit" className="absolute top-0 end-0 p-3 text-sm font-medium h-full text-white bg-[#5932EA] rounded-e-md">
                                    <svg className="w-4 md:h-4 h-4 -mt-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    ...
                    <div className="flex absolute h-screen md:ms-0 ms-5 md:me-0 me-8">
                ...
                <div className="flex relative mt-1 md:ms-0 ms-2 text-center text-xs ">
                ...
                <div className='flex relative justify-start items-start  '>
                    <div className='card-body bg-white w-72 h-8 rounded-md md:block hidden'>
                        <p className='text-gray-500 md:text-sm text-xs p-1'>2/2 Jobs in 360001, Rajkot, Gujarat, India</p>
                    </div>
                </div>
            ...
            <RWebShare data={{ text: text, title: title, url: url }}>
                <div className='fixed bottom-6 2xl:left-[33%] xl:left-[53%] sh:left-[40%] lg:left-[50%] md:left-[95%] mt-auto'>
