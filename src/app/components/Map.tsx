...
{/* 
            <div className='flex overflow-x-hidden  mt-3'>
           
               <div className='fixed overflow-scroll right-0 '>
               <div className="h-10 mt-72 left-32 z-50 fixed ">
                    <button onClick={onBackClick} className='bg-blue-700 md:hidden xm:left-36 xs:left-32 xm:bottom-96 xs:bottom-52 rounded-md px-2 py-2 text-white'>
                        <IoIosArrowBack />
                    </button>
                </div>
                <div className='flex '>
                    <div className="block md:hidden max-w-md p-2 mt-1 bg-white border border-gray-200 rounded-lg shadow">
                       ...
                       <div className="flex">
                        ...
                        <div className="flex text-sm">
                            ...
                            <div className="flex items-center ml-2">
                                <FaRegClock className='mt-1' /><p className='flex ms-1'>Part-time</p>
                            </div>
                        </div>
                        <div className='flex text-md'>
                            <div className="flex items-center mt-1">
                                <TbCurrencyDollar /><p >1000-20000</p>
                            </div>
                        ...
                        <div className='flex items-center text-sm '>
                            <IoCalendarClearOutline className='mt-1' /><p className='ml-1 mt-1'>20 d ago</p>
                        </div>
