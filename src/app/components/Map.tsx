...
//                 <div className='overflow-y-scroll h-[370px] scroll'>
...
//                     <div className='flex'>
//                         <div className="block md:hidden h-[80%] max-w-md p-2 bg-white border border-gray-200 rounded-lg shadow relative">
...
const Map: React.FC<MapProps> = ({ onBackClick }) => {
    ...
    // Prevent closing when clicking inside the map content
    ...
    // Navigate to a specific page when the Apply button is clicked
    const handleApplyClick = () => {
        Router.push('/turnto'); // Replace '/apply' with your desired route
    };
                        ...
                        <div className='flex' onClick={handleContentClick}>
                            <div className="block md:hidden h-[80%] max-w-md p-2 bg-white border border-gray-200 rounded-lg shadow relative">
                                ...
                                <div className='mb-14'>
                                    <div className="flex mt-3 text-xs">
                                        <div className="w-1/3">
                                            <button onClick={handleApplyClick} className='bg-blue-500 rounded-md px-4 py-2 text-white'>
                                                Apply
                                            </button>
                                        </div>
                                    </div>
