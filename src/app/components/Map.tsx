...
// import { TbCurrencyDollar } from "react-icons/tb";
// import { GrDirections } from "react-icons/gr";
// import { MdOutlineShare, MdBlockFlipped } from "react-icons/md";
// import { FaRegBookmark } from "react-icons/fa6";
// import { IoCalendarClearOutline } from "react-icons/io5";
// import { FaDirections } from "react-icons/fa";
...
//                     </div>
//                     <div className="w-1/2 flex justify-end items-end">
//                         <button onClick={onBack} className='bg-blue-500 rounded-md px-2 py-2'>
//                             <IoIosArrowBack />
//                         </button>
//                     </div>
//                 </div>
...
//                     <div className='flex justify-end items-end mx-auto'>
//                         <div className="flex ms-20">
//                             <button className='bg-gray-50 rounded-md shadow-lg shadow-gray-300 px-3 py-3'>
//                                 <MdOutlineShare />
//                             </button>
//                         </div>
//                         <div className="flex ms-5">
...
//                 <div className='mt-3'>
//                     <p className='font-bold'>Job Type</p>
//                     <p className='text-gray-400 bg-gray-200 w-24 p-1 rounded-md mt-1'>
