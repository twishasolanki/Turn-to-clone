...
const CustomCard: React.FC<CustomProps> = ({ onClick, onBackClick, onBackDrawerClick, onOpenDrawer, title, text, url }) => {
    ...
    return (
        <>
            <div className="hidden z-10 md:block relative md:max-w-xl lg:max-w-3xl 2xl:max-w-2xl p-2 mt-1 bg-white border border-gray-200 rounded-lg shadow">
                {items.map((item)=>(
                    <>
                  ...
                  <p className='text-lg text-blue-500 font-medium mt-1'>{item.subtitle}</p>
                  <div className="flex mt-1 text-sm">
                      <div className="flex">
                          <IoLocationOutline className='mt-1' /><p className='flex text-sm'>{item.location}</p>
                      </div>
                      <div className="flex ms-2">
                          <FaRegClock className='mt-0.5' /><p className='flex ms-1 text-sm'>{item.time}</p>
                      </div>
                      <div className="flex ms-2">
                          <TbCurrencyDollar className='mt-0.5' /><p className='text-sm'>{item.currency}</p>
                      </div>
                      <div className="flex">
                          <p className='ms-3'>1</p><GrDirections className='ms-1 text-sm' /><p>{item.calender}</p>
                      </div>
                ...
                <hr className='mt-3' />
                <p className='font-bold text-xl md:text-sm p-1'>Over View</p>
                <div className='overflow-y-scroll 3xl:h-[978px] sh:h-[377px] 2xl:h-[370px] lg:h-[135px] md:h-[126px] sw:h-[135px] scroll'>
            ...
            <div ref={mapRef} className="relative">
                <div className="flex overflow-x-hidden md:hidden block relative h-full">
                    <div className="fixed">
                        <div className="bg-black">
                            <div className="block fixed z-50 right-0 md:hidden h-screen max-w-md p-2 bg-white border border-gray-200 rounded-lg shadow">
